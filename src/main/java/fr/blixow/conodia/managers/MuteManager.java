...
public class MuteManager {
    ...
    private MuteManager(String targetName, String authorName, String reason, long endTime, long startTime, boolean isPermanent, boolean isActive, int id) {
    ...
    public MuteManager(String targetName, String authorName, String reason, long endTime, long startTime, boolean isPermanent) {
        this.targetName = targetName;
        this.authorName = authorName;
        this.reason = reason;
        this.durationLeft = endTime - startTime;
    ...
    public void handle() {
        ...
        CacheManager.getMuteCache().add(this);

        this.id = Integer.parseInt(payload.get("id").toString());
    }

    public void undo() {
        ConodiaGameAPI.getInstance().getApiManager().destroy("/sanctions/" + id + "/mute", new JSONObject());
        CacheManager.getMuteCache().remove(this);
    }
    ...
    static MuteManager from(JSONObject payload) {
